...
func (c Config) Validate() error {
	...
	if c.Symbols != "" && c.Environment == "" {
		return fmt.Errorf("symbols require environment engineering")
	}
...
type World struct {
	...
	Symbols      *SymbolState                     `json:"symbols,omitempty"`
}
