...
The [mechanisms suite](multicell-mechanisms.md) now provides the mobility controls, reaction-specific interventions and proportional chemical tracer. Its [148-trial follow-up](../experiments/multicell-mechanisms/REPORT.md) explains the bond effect through immobility and detects limited chemical coupling between generalists.
