...
The [cell contribution follow-up](multicell-roles.md) implements targeted sharing, signal, bond and acquisition interventions on these preserved witnesses. Its [first results](../experiments/multicell-roles/REPORT.md) distinguish offspring provisioning from unobserved peer sharing and leave functional integration open.
