...
[Проверка этапа 4 на 16 мирах и пример автоматического объяснения](experiments/telemetry/REPORT.md). Следующий этап по ТЗ — детектор новизны и стагнации; телеметрия пока не объявляет новый геном адаптивной новизной.
